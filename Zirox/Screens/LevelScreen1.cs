...
namespace Zirox.Screens
{
    public class LevelScreen1 : BaseScreen
    {
        ...
        {            
            ...
            //livesCounter = new LivesCounter(Content, "Amount of lives left: ", new Rectangle(centre - 50, 200, 200, 100));
        ...
        public override void Update(Game1 game, GameTime gameTime)
        {
            ...
            for (int i = 0; i < enemies.Count; i++)
            {
                if (enemies[i].Rectangle.Intersects(Zirox.Rectangle))
                {
                    ...
                    //if (livesCounter.LivesLeft>0 && Zirox.IsDead == false)
                    //{
                    //    Zirox.HasBeenHurt = true;
                    //    enemies[i].VelocityX += -enemies[i].VelocityX;
                    //    livesCounter.Update();
                    //}
                    //else if (livesCounter.LivesLeft == 0 && Zirox.IsDead == true)
                    //{
                    //    enemies[i].VelocityX += -enemies[i].VelocityX;
                    //    Zirox.IsDead = true;
                    //    livesCounter.Update();
